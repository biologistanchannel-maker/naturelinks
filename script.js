...
(function () {
  ...
  var FLORA = [
    { id: "f1", scientificName: "Berberis lycium", commonName: "Barberry", localName: "Ishkeen / Sumbul",
      ...
      image: "images/barberry-700.webp", imageSrcset: "images/barberry-700.webp 700w, images/barberry-1248.webp 1248w", districts: ["Swat", "Upper Dir", "Lower Dir", "Chitral", "Shangla"] },
    { id: "f2", scientificName: "Pinus gerardiana", commonName: "Chilghoza Pine", localName: "Chilghoza",
      ...
      image: "images/chilghoza.webp", districts: ["Chitral", "Upper Dir"] },
    { id: "f3", scientificName: "Cedrus deodara", commonName: "Deodar Cedar", localName: "Deodar / Yarokh",
      ...
      image: "images/deodar.webp", districts: ["Swat", "Upper Dir", "Kalam", "Kumrat Valley", "Lower Dir", "Chitral", "Shangla"] },
    { id: "f4", scientificName: "Saussurea lappa", commonName: "Costus Root", localName: "Kuth / Qust",
      ...
      image: "images/mountain.webp", districts: ["Shangla", "Swat", "Buner"] }
  ];
  ...
  var FAUNA = [
    { id: "a1", scientificName: "Panthera uncia", commonName: "Snow Leopard", localName: "Barfani Tendwa",
      ...
      image: "images/snow-leopard.webp", districts: ["Chitral", "Swat", "Upper Dir"] },
    { id: "a2", scientificName: "Capra falconeri cashmiriensis", commonName: "Kashmir Markhor", localName: "Mairkhwar / Markhor",
      ...
      image: "images/markhor.webp", districts: ["Chitral", "Swat", "Lower Dir"] },
    { id: "a3", scientificName: "Ursus thibetanus", commonName: "Asiatic Black Bear", localName: "Kala Reech / Janglee Khars",
      ...
      image: "images/bear.webp", districts: ["Swat", "Upper Dir", "Kumrat Valley", "Shangla"] },
    { id: "a4", scientificName: "Lophophorus impejanus", commonName: "Himalayan Monal", localName: "Monal / Sunayhar",
      ...
      image: "images/monal.webp", districts: ["Swat", "Upper Dir", "Kalam", "Chitral"] }
  ];
  ...
  function sightingImage(name) {
    ...
    if (n.indexOf("monal") >= 0 || n.indexOf("pheasant") >= 0) return "images/monal.webp";
    if (n.indexOf("berberis") >= 0 || n.indexOf("barberry") >= 0) return "images/barberry-700.webp";
    if (n.indexOf("markhor") >= 0) return "images/markhor.webp";
    if (n.indexOf("snow") >= 0 || n.indexOf("leopard") >= 0) return "images/snow-leopard.webp";
    if (n.indexOf("bear") >= 0) return "images/bear.webp";
    if (n.indexOf("pine") >= 0 || n.indexOf("chilghoza") >= 0) return "images/chilghoza.webp";
    if (n.indexOf("cedar") >= 0 || n.indexOf("deodar") >= 0) return "images/deodar.webp";
  ...
  function updateReadingBar() {
    var h = cachedScrollHeight - window.innerHeight;
  ...
  function cacheSectionBounds() {
    sectionBounds = SECTIONS.map(function (s) {
      var el = document.getElementById(s.id);
      return { key: s.key, top: el ? el.offsetTop : 0, height: el ? el.offsetHeight : 0 };
    });
  ...
  window.addEventListener("scroll", function () {
    ...
    var atBottom = window.innerHeight + window.scrollY >= cachedScrollHeight - 4;
    if (atBottom) {
      setActiveSection("contact");
      return;
    }
    for (var i = 0; i < sectionBounds.length; i++) {
      var b = sectionBounds[i];
      if (y >= b.top && y < b.top + b.height) {
        setActiveSection(b.key);
        break;
      }
    }
  }, { passive: true });
  ...
  function renderSpecies() {
    ...
    speciesGrid.innerHTML = list.map(function (s) {
      ...
      return '<div class="species-card" id="species-card-' + s.id + '">' +
        ...
        '<img src="' + s.image + '"' + (s.imageSrcset ? ' srcset="' + s.imageSrcset + '" sizes="(min-width: 768px) 45vw, 100vw"' : '') + ' alt="' + s.commonName + '" loading="lazy" />' +
  ...
  window.addEventListener("load", cacheSectionBounds);
